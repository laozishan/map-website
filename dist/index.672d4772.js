...
class App {
    ...
    _newWorkout(e) {
        ...
        if (type === "running") {
            ...
            !validInput(distance, duration, cadence) || !allPositive(distance, duration, cadence)) return alert("Inputs have to be positive number!");
            workout = new Running([
                lat,
                lng
        ...
        if (type === "cycling") {
            ...
            if (!Number.isFinite(distance, duration, elevation) || !allPositive(distance, duration)) return alert("Inputs have to be positive number!");
            workout = new Cycling([
                lat,
                lng
